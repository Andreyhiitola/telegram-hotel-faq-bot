...
# Скрипт автоматической установки Telegram FAQ бота
# Использование: bash setup.sh

echo "🤖 Установка Telegram FAQ бота..."
echo ""

# Создаём директорию проекта
PROJECT_DIR="telegram-faq-bot"
mkdir -p $PROJECT_DIR
cd $PROJECT_DIR
...
services:
  telegram-bot:
    build: .
    container_name: faq-telegram-bot
...
2. Отредактируйте файл .env и вставьте токен
...
Откройте bot.py и измените словарь FAQ под свои нужды.
EOF
...
echo "📋 Следующие шаги:"
echo ""
echo "1️⃣  Получите токен бота от @BotFather в Telegram:"
echo "   - Найдите @BotFather"
echo "   - Отправьте /newbot"
echo "   - Следуйте инструкциям"
echo ""
echo "2️⃣  Откройте файл .env и вставьте токен:"
echo "   nano .env"
echo ""
...
echo ""
echo "🎉 Готово! Бот будет работать в фоновом режиме"
echo ""
